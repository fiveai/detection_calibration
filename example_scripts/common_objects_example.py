...
calibration_model = DetectionCalibration('data/coco/calibration_val2017.json', 'data/coco/calibration_test2017.json')
...
calibrator, thresholds = calibration_model.fit('detections/deformable_detr_coco_minival.bbox.json', calibrator_type='temperature_scaling')
# Returned Params: 
...
cal_test_detections = calibration_model.transform('detections/deformable_detr_coco_minitest.bbox.json', calibrator, thresholds)
